...
@section('content')
    ...
    <form action="{{ route('dashboard.produk.update', $produk) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col">
                ...
                <div class="form-group">
                    ...
                    <select name="kategori_id" id="kategori_id" class="form-control">
                        ...
                        @foreach ($kategori as $k)
                            <option {{ old('kategori_id', $produk->kategori_id) == $k->id ? 'selected' : '' }}
                                value="{{ $k->id }}">
                                {{ $k->nama }}</option>
                        @endforeach
                    </select>
        ...
        <div class="d-flex justify-content-end">
            <button class="btn btn-primary float-right" type="submit">Edit Produk</button>
        </div>
    </form>
@endsection
